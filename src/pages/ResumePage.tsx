...
const education = [
  {
    ...
    period: '2025 — hozir',
    desc: 'Asosiy ta\'lim bilan birga mustaqil dasturlash va texnologiya sohasini o\'rganyapman.',
  },
]
    ...
    <main className="max-w-2xl mx-auto px-5 pt-28 pb-16">
      ...
      <div className="animate-fade-up mb-10">
        ...
        <div className="flex items-start justify-between flex-wrap gap-4">
          ...
          <a
            href="mailto:javohirjorayev095@gmail.com"
      ...
      <div className="bg-white border border-ink-200 rounded-2xl p-5 mb-10 animate-fade-up animate-delay-100">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
          {[
            { icon: '📧', text: 'javohirjorayev095@gmail.com', href: 'mailto:javohirjorayev095@gmail.com' },
            { icon: '📱', text: '+998 90 962 74 77', href: 'tel:+998909627477' },
            { icon: '💻', text: 'github.com/javohir095', href: 'https://github.com/javohir095' },
            { icon: '✈️', text: '@javakhir_0105', href: 'https://t.me/javakhir_0105' },
          ].map(item => (
            <a
              key={item.text}
              href={item.href}
