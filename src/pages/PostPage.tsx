    ...
    <main className="pt-24 pb-16">
      ...
      <div className="max-w-2xl mx-auto px-5">
        ...
        <div className="mt-10 bg-ink-50 border border-ink-200 rounded-2xl p-6 flex items-start gap-4">
          ...
          <div>
            <p className="font-semibold text-ink-950">Javohir Jo'rayev</p>
            ...
            <div className="flex items-center gap-3 mt-3">
              <a href="https://github.com/javohir095" target="_blank" rel="noopener noreferrer"
